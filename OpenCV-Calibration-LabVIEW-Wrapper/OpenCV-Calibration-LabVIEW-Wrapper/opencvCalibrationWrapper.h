...
extern "C" OPENCVCALIBDLL_API int32_t extractCorners(const Arr3D_U16Hdl images, const Arr_ClusterPointXYHdl maskPolygons,const ClusterPointXYHdl extractedPoints);
